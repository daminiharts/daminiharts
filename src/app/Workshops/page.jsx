...
export default async function Page() {
   const workshopProducts = await fetchProductsByType("workshop");
  const schemaData = workshopProducts.map((product) => ({
    ...
    <>
      ...
      <main className=" p-1 md:py-12 md:px-6  w-full md:px-20">
        <div className="max-w-4xl h-full   mx-auto">
          <h1 className="text-2xl md:text-3xl text-gray-900 text-center mb-8">Workshops</h1>
